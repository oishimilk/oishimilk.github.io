...
THREE.MMDLoader = ( function () {
	...
	MeshBuilder.prototype = {
		...
		build: function ( data, resourcePath, onProgress, onError ) {
			...
			//BEGIN QUAIL BLOCK
			MMDModelInformationArray[mesh.id] = data;
			//END QUAIL BLOCK
	...
	AnimationBuilder.prototype = {
		...
		build: function ( vmd, mesh ) {
			...
			//BEGIN QUAIL BLOCK
			MMDAnimationInformationArray[mesh.id].push(vmd);
			//END QUAIL BLOCK
		...
		buildCameraAnimation: function ( vmd ) {
			...
			//BEGIN QUAIL BLOCK
			MMDAnimationInformationArray[MMDCamera.id].push(vmd);
			//END QUAIL BLOCK
